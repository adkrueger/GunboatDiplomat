...
function processVidSegListResponse(response) {
	...
	for(let i = 0; i < js.vidSegs.length; i++) {
		...
		"<br/><input class=\"button\" type=\"button\" value=\"Append to Playlist\" onclick=\"requestAppendVidSeg(\'" + vs_url + id + "\')\"/>" +
		"<div class=\"divider\"></div><input class=\"button\" type=\"button\" value=\"Delete\" onclick=\"requestDelete(\'" + id + "\', \'" + charSpeaking + "\', \'" + quote + "\', 0)\"/></div></li><br/><br/>";
		/*
